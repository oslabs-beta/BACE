...
const lineBase = [
  ...
  Object.assign({}, common, {
    props: [...common.props.filter(({ prop }: any) => ['side', 'shadowSide'].indexOf(prop) === -1)],
  }),
  blending,
  polygonOffset
];
...
// object with all types of materials
interface MaterialTypesObject {
  [key:string]: any,
}

const MaterialTypes: MaterialTypesObject = {
